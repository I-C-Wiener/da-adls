...
6.1.	Users must be able to connect to the server using Jabber client (choose jabber protocol support level you can afford)
6.2.	Servers must be able to support federation i.e. messages between servers (this will require more complicated setup in docker compose)
6.3.	Use jabber library available for your tech stack.
